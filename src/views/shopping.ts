...
export const SHOPPING_CATEGORIES = [
  ...
  },
  {
    ...
    keywords: [
      ...
      // Schreibwaren & Büro
      "textmarker", "marker", "edding", "permanentmarker", "filzstift", "filzstifte",
      "kugelschreiber", "kuli", "bleistift", "buntstifte", "buntstift",
      "füller", "tintenpatrone", "tintenkiller", "wachsmalstifte", "wachsmalkreide",
      "radiergummi", "spitzer", "anspitzer", "lineal", "geodreieck",
      "korrekturroller", "tipp-ex", "korrekturband",
      "klebstoff", "klebestift", "uhustift", "flüssigkleber", "alleskleber",
      "klebeband", "tixo", "tesa", "tesafilm", "paketband",
      "schere", "bastelschere",
      "heftklammern", "tacker", "hefter", "büroklammern", "locher",
      "notizblock", "schreibblock", "collegeblock", "ringbuch", "schulheft", "heft",
      "haftnotizen", "post-it", "klebezettel",
      "briefumschlag", "briefumschläge", "kuvert", "kuverts", "umschlag",
      "ordner", "aktenordner", "mappe", "sichtmappe", "register", "klarsichthülle",
      "etiketten", "aufkleber", "stempel", "stempelkissen",
      "malbuch", "zeichenpapier", "tonpapier", "bastelpapier",
      "knete", "wasserfarben", "fingerfarben",
      // English
      "highlighter", "ballpoint pen", "pencil", "crayons", "felt tip",
      "eraser", "sharpener", "ruler", "glue stick", "glue", "tape", "scotch tape",
      "scissors", "stapler", "staples", "paper clips", "hole punch",
      "notebook", "notepad", "sticky notes", "envelope", "envelopes",
      "folder", "binder", "labels", "marker pen",
      // Español
      "rotulador", "marcador", "bolígrafo", "lápiz", "lápices de colores",
      "goma de borrar", "sacapuntas", "regla", "pegamento", "barra de pegamento",
      "cinta adhesiva", "celo", "tijeras", "grapadora", "grapas", "clips",
      "cuaderno", "libreta", "notas adhesivas", "sobre", "sobres",
      "carpeta", "archivador", "etiquetas",
      // English
