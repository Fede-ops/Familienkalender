...
export const TODO_CATEGORIES = [
  ...
  },
  {
    ...
    keywords: [
      ...
      "party", "feier", "feiern",
      "fußball", "fussball", "basketball", "tennis", "volleyball", "schwimmen", "schwimmkurs",
      "radfahren", "fahrrad", "mountainbike", "radtour", "fahrradtour", "e-bike tour",
      "wandern", "trekking", "klettern", "bergwandern", "bergsteigen", "klettersteig", "bouldern", "kletterpark",
      ...
      "spa", "wellness",
      // Österreichische Freizeit
      "fussballtraining", "fussballspiel", "fussballverein", "fussballmatch",
      "skifahren", "schilaufen", "ski", "snowboarden", "snowboard", "langlaufen", "skitour",
      "eislaufen", "schlittschuhlaufen", "rodeln", "schlitten fahren",
      "schneeschuhwandern",
      "schwimmbad", "freibad", "hallenbad", "badminton", "squash", "tischtennis",
      "therme", "badesee", "see",
      "heuriger", "heurigen", "buschenschank",
      "minigolf", "golf", "bowling", "billiard", "billard", "darts", "dart",
      "schach", "brettspiel", "brettspiele",
      "angeln", "fischen",
      "escape room", "lasertag", "paintball",
      "camping", "zelten", "campen",
      "segeln", "surfen", "tauchen", "kanufahren", "paddeln", "kajakfahren",
      "tanzkurs", "salsakurs", "tanzabend",
      "sprachkurs", "sprachen lernen",
      "backen als hobby", "kochen kurs",
      "singen", "chor",
      "open air", "freiluftkino", "autokino",
      "festival",
      "vernissage", "galerie besuch",
      "zoo", "tierpark", "aquarium", "planetarium",
      "stadtbummel", "flanieren", "bummeln",
      "tagesausflug", "wochenendausflug",
      // English
  ...
  },
  {
    ...
    keywords: [
      ...
      "sportverein", "fußballtraining", "fussballtraining", "tanzstunde", "musikstunde",
      "kurs", "kursanmeldung",
      "schulbus", "fahrgemeinschaft",
      "schulranzen", "schulbedarf", "schulmaterial",
      "impfung", "vorsorgeuntersuchung kind",
      // Österreichische Schulbegriffe
      "volksschule", "hauptschule", "gymnasium", "mittelschule", "nms", "aps", "hs", "bhs", "bms",
      "schuleinschreibung", "schulanmeldung", "schnuppertag",
      "nachmittagsbetreuung", "ganztagesschule", "tagesbetreuung",
      "jause", "pausenjause", "schuljause",
      "sportwoche", "schikurs", "schulskikurs",
      "schulaufführung", "schulkonzert", "schultheater", "schulball", "maturaball",
      "zeugnistag", "schulschluss", "schulbeginn",
  ...
  },
  {
    ...
    keywords: [
      ...
      "yoga", "meditieren", "entspannen", "atemübungen",
  ...
  },
  {
    ...
    keywords: [
      ...
      "elektriker", "strom",
      "heizung", "heizung warten", "heizungsmonteur", "heizöl bestellen", "pellets bestellen", "hackschnitzel bestellen", "kamin reinigen", "kaminkehrer",
      "maler", "malerarbeiten",
      ...
      // Österreichisch
      "pickerl", "kfz-pickerl", "pkw pickerl", "hauptuntersuchung",
      "reifenwechsel", "winterreifen aufziehen", "sommerreifen aufziehen", "winterreifen", "sommerreifen",
      "auto service", "kfz service", "autowerkstatt",
      "schneeschaufeln", "schneeräumen", "schneekehren",
      "laub harken", "laubrechen", "laubfegen",
      "hecke schneiden", "bäume schneiden", "äste schneiden",
      "keller aufräumen", "dachboden aufräumen", "abstellraum räumen",
      "pool reinigen", "pool öffnen", "poolabdeckung",
      // English
...
export async function syncTodosFromHA(): Promise<TodoItem[] | null> {
  ...
  const localItems = loadTodoItems();
  try {
